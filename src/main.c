    ...
    case 0:
      ...
      switch (cell_index->row) {
        case 0:
          ...
          menu_cell_basic_draw(ctx, cell_layer, "Devices", "Control devices", menu_icons[current_icon]);
          break;

        case 1:
          // This is a basic menu icon with a cycling icon
          menu_cell_basic_draw(ctx, cell_layer, "Actions", "Execute actions", menu_icons[(current_icon + 1) % NUM_MENU_ICONS]);
          break;
      }
      break;
  }
